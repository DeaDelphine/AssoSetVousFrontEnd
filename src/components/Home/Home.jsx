...
import logoHome from '../../assets/images/Logo-Photoroom.png';
import homeImg from '../../assets/images/istockphoto-1145183127-612x612.jpg';
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className='home_content'>
                                <div className='home_title'><img src={logoHome} alt="Logo Asso's" className="img-fluid" id="logo_home" />Asso'S & Vous</div>
                                <div>
